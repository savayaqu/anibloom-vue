...
<template>
  <footer style="margin-top: 100px; padding-bottom: 20px;">
    <div style="display: flex; justify-content: space-between">
      ...
      <div class="footer">
        ...
        <div style="margin-top: 40px;">
          ...
          <p style="margin-top: 5px;">Филиал Новосибирск (с 11:00 до 20:00)</p>
          <p style="font-weight: bold; font-size: 21px; margin-top: 15px;">+7 (923) 181-74-43</p>
        </div>
